...
class API {
  ...
  public async req_wearableDcl_list(page: number, count: number,
    ...
    // const url = `http://8.130.23.16/api/v1/get_dcl_wearable_list${search}`;
    const result = await fetch(url, {
      method: 'get',
      mode: 'cors',
    });
  ...
  public async req_wearableViverse_list(page: number, count: number,
    //  world: string,
  ) {
    const search = qs.stringify({ page, count }, { addQueryPrefix: true });
    // const url = `${this.url}/wearable/get_mona_wearable_list${search}`;
    const url = `${this.url}/wearable/get_viverse_wearable_list${search}`;
    const result = await fetch(url, {
      method: 'get',
      mode: 'cors',
    });
  ...
  public async req_wearableSandBox_list(page: number, count: number,
    //  world: string,
  ) {
    const search = qs.stringify({ page, count }, { addQueryPrefix: true });
    // const url = `${this.url}/wearable/get_mona_wearable_list${search}`;
    const url = `${this.url}/wearable/get_sandbox_avatars_list${search}`;
    const result = await fetch(url, {
      method: 'get',
      mode: 'cors',
    });
...
'Access-Control-Allow-Origin':'*'},
  ...
  public async req_detailWearableSandBox_list( avatar_id,
  ) {
    const search = qs.stringify({ avatar_id }, { addQueryPrefix: true });
    const url = `${this.url}/wearable/get_sandbox_avatar_detail${search}`;
    const result = await fetch(url, {
      method: 'get',
      mode: 'cors',
    });
  ...
  public async req_detailViverse_list( wearable_id,
  ) {
    const search = qs.stringify({  wearable_id }, { addQueryPrefix: true });
    const url = `${this.url}/wearable/get_viverse_wearable_detail${search}`;
    const result = await fetch(url, {
      method: 'get',
      mode: 'cors',
    });
