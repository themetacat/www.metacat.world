...
class API {
  ...
  //   const url = "http://8.130.23.16/api/v1/get_build_builders_list"
  //   const result = await fetch(url, {
  //     method: 'get',
  //     mode: 'cors',
  //   });
  ...
  //   const url = "http://8.130.23.16/api/v1/wearable/get_wearable_creators"
  ...
  //   }
  //   const url = `http://8.130.23.16/api/v1/get_topic_detail${search}`
  //   const result = await fetch(url, {
  //     method: 'get',
  //     mode: 'cors',
  //   });
