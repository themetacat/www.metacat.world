...
import {
  ...
  req_playerone_sales_amount,
  req_playerone_sales_num,
  req_playerone_avg_price,
...
export default function AnalyticsIndex(props, iconImgLight: Props) {
  ...
  const scrollToAnchor = (anchorName) => {
    ...
    if (anchorName) {
      ...
      } else if (anchorName === 'ParcelSalesAmount(USD)') {
      ...
      } else if (anchorName === 'ParcelSalesAmount') {
      ...
      } else if (anchorName === 'ComprehensiveData') {
      ...
      } else if (anchorName === 'ParcelSalesAmountM2M') {
      ...
      } else if (anchorName === 'AverageParcelPriceM2M') {
      ...
      } else if (anchorName === 'ParcelRentAmount') {
      ...
      } else if (anchorName === 'NumberOfParcelRent') {
      ...
      router.replace(`/analytics#${anchorName}`)
      // window.scrollTo({
      //   top: 500,
      //   left: 100,
      //   behavior: "smooth"
  ...
  React.useEffect(() => {
    ...
    } else if (idVal === 'AverageParcelPrice') {
      const idValCon = document.querySelector('.analytics_allLine1__W4ibX, .analytics_allLine2__xUO23');
      if (idValCon) { idValCon.scrollIntoView({ block: 'start', behavior: 'smooth' }); }
      console.log(window && window.scrollY);
    ...
    } else if (idVal === 'ParcelSalesAmount') {
      const idValCon = document.querySelector('.analytics_allLine__caJyn');
      if (idValCon) { idValCon.scrollIntoView({ block: 'start', behavior: 'smooth' }); }
      window.scrollTo({
        top: 850,
    ...
    } else if (idVal === 'ComprehensiveData') {
      const idValCon = document.querySelector('.analytics_tabContainer__BZNAm');
      if (idValCon) { idValCon.scrollIntoView({ block: 'start', behavior: 'smooth', }); }
      setTimeout(() => {
        window.scrollTo({
    ...
    } else if (idVal === 'ParcelSalesAmountM2M') {
      const idValCon = document.querySelector('.analytics_tabContainer1__BDS2H');
      if (idValCon) { idValCon.scrollIntoView({ block: 'start', behavior: 'smooth' }); }
      setTimeout(() => {
        window.scrollTo({
    ...
    } else if (idVal === 'AverageParcelPriceM2M') {
      const idValCon = document.querySelector('.analytics_tabContainer2__yWp4H');
      if (idValCon) { idValCon.scrollIntoView({ block: 'start', behavior: 'smooth' }); }
      setTimeout(() => {
        window.scrollTo({
    ...
    } else if (idVal === 'ParcelRentAmount') {
      const idValCon = document.querySelector('.analytics_allLineb__R3vbO');
      if (idValCon) { idValCon.scrollIntoView({ block: 'start', behavior: 'smooth' }); }
      setTimeout(() => {
        window.scrollTo({
    ...
    } else if (idVal === 'NumberOfParcelRent') {
      const idValCon = document.querySelector('.analytics_allLinen__iALvW');
      if (idValCon) { idValCon.scrollIntoView({ block: 'start', behavior: 'smooth' }); }
      window.scrollTo({
        top: 3350,
