...
import { req_detailWearableSandBox_list } from '../../../service/z_api';
...
export default function CreationWearableList({
    ...
    const init = React.useCallback(() => {
        ...
        const res = req_detailWearableSandBox_list(router.query.avatar_id);
        res.then((resWear) => {
    ...
    // camera.updateProjectionMatrix();
          ...
          loader?.load(
            ...
            function (gltf) {
              ...
              modelGlft.scale.set(0.03, 0.03, 0.03);
